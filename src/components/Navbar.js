...
import fullLogo from '../full_logo_3.png';
import {
    ...
    return (
      <div className="">
        <nav className="w-screen">
          <ul className='flex items-start justify-between py-3 bg-transparent text-white pr-5'>
          ...
          <li>
            <ul className='lg:flex justify-start font-bold mr-10 text-lg'>
              ...
              <li className='border-b-2 hover:pb-0 p-2'>
                <Link to="/sellNFT">Create NFTs</Link>
              </li>
              :
              <li className='hover:border-b-2 hover:pb-0 p-2'>
                <Link to="/sellNFT">Create NFTs</Link>
              ...
              <li className='nearBtn border-b-2 hover:pb-0 p-2'>
                <Link to="/profile">My Profile</Link>
              </li>
              :
              <li className='nearBtn hover:border-b-2 hover:pb-0 p-2'>
                <Link to="/profile">My Profile</Link>
              </li>              
              }  
              <li>
